...
namespace Vicevært.Web.Infrastructure
{
    public class BookingServiceProxy : IBookingService
    {
        ...
        async Task IBookingService.CreateAsync(BookingDto bookingDto)
        {
            ...
            await _client.PostAsync("https://localhost:49159/api/Booking", bookingDtoJson);
        }
        ...
        {
            return await _client.GetFromJsonAsync<IEnumerable<BookingDto>>("https://localhost:49159/api/Booking");
        }
